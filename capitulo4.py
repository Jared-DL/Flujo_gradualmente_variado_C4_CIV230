...
def calcular_H2_para_seccion_rectangular(tirante_inicial,altura_del_canal_inicial,altura_del_canal_final,delta_x):
    ...
    tirante_final-=0.00001
    tirante_final=hallar_tirante_final_con_error_rectangular(tirante_final,S1,H1,altura_del_canal_final,delta_x,0.000001)
    tirante_final-=0.000001
    tirante_final=hallar_tirante_final_con_error_rectangular(tirante_final,S1,H1,altura_del_canal_final,delta_x,0.0000001)  
    tirante_final-=0.0000001
    tirante_final=hallar_tirante_final_con_error_rectangular(tirante_final,S1,H1,altura_del_canal_final,delta_x,0.00000001)
    tirante_final-=0.00000001
    tirante_final=hallar_tirante_final_con_error_rectangular(tirante_final,S1,H1,altura_del_canal_final,delta_x,0.000000001)
